...
import { SidebarComponent } from "src/app/core/admin/layout/sidebar/sidebar.component";
import { TopbarComponent } from 'src/app/core/admin/layout/topbar/topbar.component';
@Component({
  selector: 'app-leader',
  templateUrl: './leader.component.html',
})
export class LeaderComponent implements OnDestroy {
